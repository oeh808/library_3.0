...
public class StudentControllerTest {
    ...
    public void getStudentsByName_Empty() throws Exception {
        when(studentService.getStudentsByName('"' + student.getName() + '"')).thenReturn(new ArrayList<Student>());
    ...
    public void getStudentsByAddress_Empty() throws Exception {
        when(studentService.getStudentsByAdress('"' + student.getAddress() + '"')).thenReturn(new ArrayList<Student>());
