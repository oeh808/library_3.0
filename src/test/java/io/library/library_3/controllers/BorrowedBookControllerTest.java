...
public class BorrowedBookControllerTest {
        ...
        public void borrowBook_SuccessLibrarian() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                .post("/borrowing/librarians/" + user.getId() + "/" + book.getRefId())
        ...
        public void borrowBook_SuccessStudent() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                .post("/borrowing/students/" + user.getId() + "/" + book.getRefId())
                                .content(mapper.writeValueAsString(creationDTO))
                                .contentType(MediaType.APPLICATION_JSON))
                                .andExpect(status().isOk())
                                .andExpect(content().json("{}"));
        ...
        public void borrowBook_BookNonExistant() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                ...
                                .andExpect(
                                                jsonPath("$.message")
                                                                .value("ERROR: " + BookExceptionMessages
                                                                                .REFID_NOT_FOUND(book.getRefId())));
                ;
        ...
        public void borrowBook_UserNonExistant() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                ...
                                .andExpect(
                                                jsonPath("$.message")
                                                                .value("ERROR: " + StudentExceptionMessages
                                                                                .ID_NOT_FOUND(user.getId())));
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                ...
                                .andExpect(
                                                jsonPath("$.message")
                                                                .value("ERROR: " + LibrarianExceptionMessages
                                                                                .ID_NOT_FOUND(user.getId())));
        }
        ...
        public void getBooksBorrowedByUser_UserExistant() throws Exception {
                when(borrowedBookService.getBooksBorrowedByUser(user.getId(), UserTypeCustom.STUDENT))
                                .thenReturn(books);
                when(borrowedBookService.getBooksBorrowedByUser(user.getId(), UserTypeCustom.LIBRARIAN))
                                .thenReturn(books);
